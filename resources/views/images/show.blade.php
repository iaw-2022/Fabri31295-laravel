...
<div id="card-form" class="card bg-dark mb-3">
    <div id="card-header2" class="card-header text-center">{{$image->name}}</div>
        <div class="card-body bg-white"\>
            <div class="mb-3">
                <img class="myImages" src="{{$image->url}}" alt="{{$image->name}}" width="180px;" height="120px;"/>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label class="form-label">Precio en U$S</label>
                    <p>{{$image->price}}</p>
            </div>
            <div id="buttons-forms">
                <a href="/images" class="btn btn-primary" tabindex="5">Volver</a>
            </div>
        </div>
    </div>
</div>
