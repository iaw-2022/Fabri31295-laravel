...
<div class="card bg-white mb-3">
                <div class="card-header text-white text-center" style="background-color: #343a40;">Resoluciones</div>
                    <div class="card-body" style="background-color: #F0E9D2;">
                        <table id="resolutions-table" class="table text-center table-white table-bordered">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Resolucion</th>
